...
export default function HangoutPage() {
    return (
        <div className="flex items-center bg-white max-w-[1217px] flex-col justify-center mx-auto w-50">
          <div className="flex w-[522px] max-w-full flex-col items-center">
 
            {/* box 1 */}
            <div className="flex flex-col bg-gray-800 w-full rounded-xl pl-3.5 pr-6 py-4 max-md:max-w-full max-md:pr-5">
              <div className="relative flex justify-between gap-5 px-0.5 items-start max-md:max-w-full max-md:flex-wrap max-md:justify-center">
                ...
                <button className='bg-[#2e3f40] text-[#00fca9] px-5 py-1 rounded-md text-sm'>Join</button>
                <></>
              </div>
            ...
            {/* Host button that navigates to the newMeeting */}
            <Link to="/dashboard/newHangout">
